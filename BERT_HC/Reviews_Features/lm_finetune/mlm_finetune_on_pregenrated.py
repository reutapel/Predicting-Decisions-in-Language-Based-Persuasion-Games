...
from BERT.bert_mlm_finetune import BertForMLMPreTraining
from .pregenerate_training_data import EPOCHS
from BERT.bert_text_dataset import BertTextDataset
from utils import init_logger
import os

from bert_constants import RANDOM_SEED, BERT_PRETRAINED_MODEL, NUM_CPU, REVIEWS_FEATURES_PRETRAIN_DATA_DIR, \
    REVIEWS_FEATURES_PRETRAIN_MLM_DIR
...
logger = init_logger("MLM-pretraining", f"{REVIEWS_FEATURES_PRETRAIN_MLM_DIR}")
...
def main(exp_num='1'):
    ...
    args.output_dir = Path(REVIEWS_FEATURES_PRETRAIN_MLM_DIR) / args.exp_num / "model"
    args.fp16 = FP16
    pretrain_on_exp(args)
